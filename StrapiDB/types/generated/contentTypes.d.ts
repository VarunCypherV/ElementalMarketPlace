...
export interface ApiItemsCollectionItemsCollection
  ...
  attributes: {
    Name: Attribute.String;
    SP: Attribute.Integer;
    CP: Attribute.Integer;
    ...
    vendors: Attribute.Relation<
      'api::items-collection.items-collection',
      'manyToOne',
      'api::vendor-collection.vendor-collection'
    >;
    ItemId: Attribute.UID;
    user_collections: Attribute.Relation<
      'api::items-collection.items-collection',
      'manyToMany',
...
export interface ApiReviewReview extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Date: Attribute.Date;
    ImagesVideo: Attribute.Media;
    reviewId: Attribute.Relation<
      'api::review.review',
      'manyToOne',
      'api::items-collection.items-collection'
    >;
...
export interface ApiUserCollectionUserCollection extends Schema.CollectionType {
  ...
  attributes: {
    items_visited: Attribute.Relation<
      'api::user-collection.user-collection',
      'manyToMany',
      'api::items-collection.items-collection'
    >;
...
export interface ApiVendorCollectionVendorCollection
  ...
  attributes: {
    ...
    IdProof: Attribute.Media;
    CompanyName: Attribute.String;
    CompanyAddress: Attribute.Text;
    IdProofName: Attribute.String;
    BankACNo: Attribute.String;
    GSTNumber: Attribute.String;
    VendorPhone: Attribute.BigInteger;
    items_collections: Attribute.Relation<
      'api::vendor-collection.vendor-collection',
      'oneToMany',
      'api::items-collection.items-collection'
    >;
